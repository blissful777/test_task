...
const validationConfig = {
    ...
    inputSelector: '.form__body_item',
    errorClass: 'error-message_visible',
    inputInvalidClass: 'form__body_item_invalid',
    buttonSelector: '.form__body_save-button',
    buttonDisabledClass: 'form__body_save-button_disabled'
};
